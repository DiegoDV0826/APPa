//
//  TableViewControllerInfo.swift
//  APPa
//
//  Created by user189690 on 5/13/21.
//
...
class TableViewControllerInfo: UITableViewController {
    ...
    */
    ...
    @IBAction func noIncluirBtn(_ sender: UIButton) {
        UIApplication.shared.open(URL(string: "https://normas-apa.org/referencias/#que-no-debo-incluir")! as URL, options: [:], completionHandler: nil)
    }
    
    @IBAction func elementosBtn(_ sender: Any) {
